...
/**
 * The deserializer class, that deserializes the float data.
 */
@SuppressWarnings("unchecked")
public class FloatDeserializer extends AbstractDeserializer {

    public FloatDeserializer(com.google.protobuf.CodedInputStream input, Descriptors.FieldDescriptor fieldDescriptor,
    ...
    public void deserialize() throws IOException {
        ...
        if (isBMap()) {
            ...
            if (fieldDescriptor.isRepeated()) {
                ...
                bMap.put(bFieldName, Double.parseDouble(String.valueOf(input.readFloat())));
            }
        } else {
    ...
    private double readContent() throws IOException {
        ...
        return Double.parseDouble(String.valueOf(input.readFloat()));
    }
}
