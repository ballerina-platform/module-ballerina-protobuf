...
/**
 * The deserializer class, that deserializes the fixed 32 data.
 */
@SuppressWarnings("unchecked")
public class Fixed32Deserializer extends AbstractDeserializer {

    public Fixed32Deserializer(com.google.protobuf.CodedInputStream input, Descriptors.FieldDescriptor fieldDescriptor,
