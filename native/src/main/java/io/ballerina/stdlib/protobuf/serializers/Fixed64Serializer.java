...
/**
 * The serializer class, that serializes the fixed64 values.
 */
@SuppressWarnings("unchecked")
public class Fixed64Serializer extends AbstractSerializer {

    public Fixed64Serializer(com.google.protobuf.CodedOutputStream output, Descriptors.FieldDescriptor fieldDescriptor,
                             BMessage bMessage) {
    ...
    private int computeMessageSize(long value) {
        ...
        return com.google.protobuf.CodedOutputStream.computeFixed64Size(fieldDescriptor.getNumber(), value);
    }

    private void writeContent(long content) throws IOException {

        output.writeFixed64(fieldDescriptor.getNumber(), content);
    }
}
