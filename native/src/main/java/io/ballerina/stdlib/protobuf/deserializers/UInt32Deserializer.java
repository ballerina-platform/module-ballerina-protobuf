...
public class UInt32Deserializer extends AbstractDeserializer {

    public UInt32Deserializer(com.google.protobuf.CodedInputStream input, Descriptors.FieldDescriptor fieldDescriptor,
