...
/**
 * The serializer class, that serializes the fixed32 values.
 */
@SuppressWarnings("unchecked")
public class Fixed32Serializer extends AbstractSerializer {

    public Fixed32Serializer(com.google.protobuf.CodedOutputStream output, Descriptors.FieldDescriptor fieldDescriptor,
                             BMessage bMessage) {
    ...
    private int computeMessageSize(int value) {
        ...
        return com.google.protobuf.CodedOutputStream.computeFixed32Size(fieldDescriptor.getNumber(), value);
    }

    private void writeContent(int content) throws IOException {

        output.writeFixed32(fieldDescriptor.getNumber(), content);
    }
